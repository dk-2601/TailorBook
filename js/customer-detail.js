(function () {
  ...
  function render() {
    ...
    panel.innerHTML =
      ...
      "<div class='highlight-card'><p class='label'>Total Paid</p><p class='value'>₹ " + totals.totalPaid.toFixed(0) + "</p></div>" +
      "<div class='highlight-card'><p class='label'>Balance</p><p class='value'>₹ " + totals.balance.toFixed(0) + "</p></div>" +
