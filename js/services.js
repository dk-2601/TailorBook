(function () {
  ...
  function renderServices() {
    ...
    filtered.forEach(function (service) {
      ...
      toggleLabel.title = service.isActive ? "Active" : "Inactive";
      toggleLabel.setAttribute("aria-label", "Active toggle");

      const toggleInput = document.createElement("input");
      toggleInput.type = "checkbox";
      toggleInput.checked = Boolean(service.isActive);
      ...
      toggleInput.addEventListener("change", function () {
        TailorStorage.setServiceActive(service.id, Boolean(toggleInput.checked));
        loadServices();
        renderServices();
      });
      ...
      editBtn.innerHTML = "<span class='btn-icon' aria-hidden='true'>" + iconSvg("edit") + "</span><span>Edit</span>";
      ...
      toggleBtn.innerHTML =
        ...
        iconSvg(service.isActive ? "deactivate" : "activate") +
        "</span><span>" +
