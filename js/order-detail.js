(function () {
  ...
  function render() {
    ...
    head.innerHTML =
      ...
      "<button type='button' id='viewBillBtn' class='mini-btn ok-btn'>View Bill</button>" +
      "<button type='button' id='orderEditBtn' class='mini-btn'>" + (editMode ? "Cancel Edit" : "Edit") + "</button>" +
      "<button type='button' id='orderDeleteBtn' class='mini-btn danger-btn'>Delete</button>" +
      "</div>";
    ...
    form.appendChild(field("Notes", "notes", order.notes || "", editMode, "textarea"));
  ...
  function field(label, name, value, editable, type, options) {
    const wrap = document.createElement("div");
